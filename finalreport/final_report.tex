...
\section{Final System Overview}
  ...
  functionality and user interface of the system repectivley which are detailed
  bellow. In addition to these components there is a database schema and
  prototype dataset which have been produced.

  \subsection{Catalogue}

  The catalogue portion of the system has been built as an independant Python
  ...
  swapped out very easily and would allow the use of scallable cloud-based
  databases such as AWS RDS.

  The main functionaily of the module is provided by \textit{catalogue.py}, in
  ...
  All database tables have an \textit{add} methond, as well as \textit{get}
  ...
  example every \textit{post} belongs to a \textit{story}. This was achived by
  ...
  timeframe a better solution to this problem could have been found by utilising
  ...
  would have reduced the independance between the database and data management
  system.

  The rest of the methods in the class provide specific data access as needed by
  other elements fo the system. Methods such as \textit{get\_user\_by\_name} are
  required to filfill a specific purpose and were added as and when the need
