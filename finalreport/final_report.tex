...
%To-Do: Write system development
  ...
  This compatmentalisation also streamlined development significantly as each
  element could be re-written independantly of the rest of the system. This
  ...
  focus was instead on choosing technologies and languages that woulld
  facilitate rapid development and innovation. As such, the chosen platforms are
  all ones that the author has a lot of experience with.
  ...
  developing the system. To create the API and backend portions of the system
  Flask was used as this fit well with the rapid protoyping nature of the
  project. Flask also provides the Jinja templating engine which made producing
  web pages fast and efficient. These pages were built using pure HTML, CSS and
  Javascript as this avoided having to learn new user interface frameworks.

  \subsection{Issues Faced}

  The main issues faced during the project were around the need to balance the
  benifit of adding a feature with the time it would take to implement. The best
  example of this is when it was realised that a ground up re-write of the
  catalogue module would be highly benifitial to the project, however it would
