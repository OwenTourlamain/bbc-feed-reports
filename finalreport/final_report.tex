...
\section{Methodology and Planning}
  ...
  \clearpage %To-Do: Re-do gantt chart
...
\section{Final System Overview}
  ...
  %To-Do: Lack of mobile interface

%To-Do: Add system diagrams

%To-Do: Add UI screenshots

\section{Informal Evaluation}

%To-Do: Write informal evaluation - interview booked for 27/5

% Negatives:
%   Needs smoothing - get rid of topic selection
%   Needs interaction - like/upvote
%
% Positives:
%   Data interface is interesting
%   UI is clean on well designed
%   Data structures are very interesting
